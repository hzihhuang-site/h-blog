...
tags: [React生态]
categories: [前端, React]
cover: https://img2.baidu.com/it/u=3519480490,3675224161&fm=253&fmt=auto&app=120&f=JPEG
date: 2022-11-23 13:12:31
...
> 平常我们编程跳转路由需要 useNavigate() 这个hooks，然而由于 hooks 的限制，我们只能在组件内部使用。所以在想在寻常的 function 中跳转路由时不现实的，所以就有了这个
>
> 可以组件外部跳转路由——常用于 axios 中请求拦截中判断是否登陆跳转 login
...
// history 使用 export 导出，后面在方法中需要跳转路由可以引入此 history 然后 history.push(path)
